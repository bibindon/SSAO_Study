...
HWND g_hIndirectLightStrengthEdit = NULL;
HWND g_hApplyIndirectLightStrengthButton = NULL;
HWND g_hLockRandomDirectionsCheckbox = NULL;
HWND g_hIndirectLightMaxContributionEdit = NULL;
HWND g_hApplyIndirectLightMaxContributionButton = NULL;
HWND g_hIndirectBlendLerpRadio = NULL;
HWND g_hIndirectBlendMultiplyRadio = NULL;
